    ...
    public function run()
    {
        ...
        $promotions = [
            ...
            [
                ...
                'description' => 'Livraison gratuite pour toute commande supérieure à 75€. Profitez-en !',
                'type' => 'free_shipping',
                'value' => 7.90,
            ...
            [
                ...
                'description' => 'Bienvenue ! Profitez de 15€ de réduction sur votre première commande de plus de 100€.',
                'type' => 'fixed_amount',
                'value' => 15.00,
