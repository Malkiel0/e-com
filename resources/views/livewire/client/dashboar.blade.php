        ...
        <div class="max-w-7xl mx-auto px-4 py-6">
            <div class="flex flex-col lg:flex-row gap-6 items-center justify-between">
                ...
                <div class="text-center lg:text-left">
                    <h1 class="text-3xl lg:text-4xl font-display font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
                        ✨ Tous nos Produits
                    </h1>
                ...
                <div class="w-full lg:w-96">
                    <div class="relative">
                        ...
                        @if($search)
                            <button wire:click="$set('search', '')" class="absolute right-4 top-1/2 transform -translate-y-1/2">
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="lg:w-80 {{ $showFilters ? 'block' : 'hidden lg:block' }}">
                <div class="bg-white/70 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/20 sticky top-32">
                    ...
                    <button wire:click="$set('search', ''); $set('selectedCategory', ''); $set('selectedBrand', ''); $set('minPrice', 0); $set('maxPrice', 1000)" 
                    ...
                    <div class="{{ $viewMode === 'grid' ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8' : 'space-y-6' }}">
                        @foreach($products as $product)
                            <div class="product-card group" 
                                ...
                                @if($viewMode === 'grid')
                                    {{-- Vue grille --}}
                                    <div class="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105">
                                        {{-- Image produit --}}
                                        <div class="relative aspect-square overflow-hidden cursor-pointer" 
                                            ...
                                            @if($product->primaryImage)
                                                <img src="{{ Storage::url($product->primaryImage->file_path) }}" 
                                                     ...
                                                     loading="lazy">
                                            @else
                                                <div class="w-full h-full bg-gradient-to-br {{ strpos(strtolower($product->category->name), 'parfum') !== false ? 'from-purple-100 to-purple-200' : 'from-pink-100 to-pink-200' }} flex items-center justify-center">
                                                    <span class="text-6xl">
                                            ...
                                            <div class="absolute top-4 left-4 flex flex-wrap gap-2">
                                                @if($product->is_new)
                                                    <span class="bg-gradient-to-r from-emerald-500 to-teal-500 text-white text-xs font-bold px-3 py-1 rounded-full">
                                                        ✨ NOUVEAU
                                                    </span>
                                                @endif
                                                @if($product->original_price && $product->price < $product->original_price)
                                                    <span class="bg-gradient-to-r from-red-500 to-orange-500 text-white text-xs font-bold px-3 py-1 rounded-full">
                                ...
                                @else
                                    {{-- Vue liste --}}
                                    <div class="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300">
                                                    ...
                                                    <div class="flex-1">
                                                        ...
                                                        <div class="flex items-center space-x-4 mb-3">
                                                            ...
                                                            <div class="flex space-x-2">
                                                                @if($product->is_new)
                                                                    <span class="bg-gradient-to-r from-emerald-500 to-teal-500 text-white text-xs font-bold px-2 py-1 rounded-full">
                                                                        ✨ NOUVEAU
                                                                    </span>
                                                                @endif
                                                                @if($product->is_bestseller)
                                                                    <span class="bg-gradient-to-r from-yellow-500 to-orange-500 text-white text-xs font-bold px-2 py-1 rounded-full">
                                                                        🔥 TOP
                                                                    </span>
                                                                @endif
                                                            </div>
                                                        ...
                                                        <div class="flex md:flex-col space-x-2 md:space-x-0 md:space-y-2">
                                                            ...
                                                            <div class="flex space-x-2">
                                                                ...
                                                                <button wire:click="toggleWishlist({{ $product->id }})"
                                                                        :class="inWishlist ? 'bg-red-500 text-white' : 'bg-gray-100 text-gray-600'"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="aspect-square rounded-2xl overflow-hidden bg-gray-100">
                                ...
                                @else
                                    <div class="w-full h-full bg-gradient-to-br {{ strpos(strtolower($selectedProduct->category->name), 'parfum') !== false ? 'from-purple-100 to-purple-200' : 'from-pink-100 to-pink-200' }} flex items-center justify-center">
                                        <span class="text-8xl">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-3 mb-6">
                                    <span class="text-3xl font-bold text-gray-900">{{ $selectedProduct->price }}€</span>
                                    @if($selectedProduct->original_price && $selectedProduct->price < $selectedProduct->original_price)
                                        <span class="text-xl text-gray-500 line-through">{{ $selectedProduct->original_price }}€</span>
                                    ...
                                    <div class="space-y-2">
                                        @foreach($selectedProduct->fragrance_notes as $noteType => $notes)
                                            <div class="flex items-start space-x-3">
                                                <span class="text-sm font-medium text-gray-500 min-w-[80px] capitalize">{{ $noteType }}:</span>
                                                <span class="text-sm text-gray-700">{{ is_array($notes) ? implode(', ', $notes) : $notes }}</span>
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        sliders.forEach(slider => {
            slider.style.background = `linear-gradient(to right, #8B5CF6 0%, #8B5CF6 ${(slider.value - slider.min) / (slider.max - slider.min) * 100}%, #e5e7eb ${(slider.value - slider.min) / (slider.max - slider.min) * 100}%, #e5e7eb 100%)`;
            
            slider.addEventListener('input', function() {
                this.style.background = `linear-gradient(to right, #8B5CF6 0%, #8B5CF6 ${(this.value - this.min) / (this.max - this.min) * 100}%, #e5e7eb ${(this.value - this.min) / (this.max - this.min) * 100}%, #e5e7eb 100%)`;
            });
        });
    });
</script>
